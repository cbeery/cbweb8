class Admin::Concerts::ArtistsController < Admin::BaseController
  ...
  def create
    ...
    if @artist.save
      redirect_to admin_concerts_artist_path(@artist), notice: 'Artist was successfully created.'
    else
  ...
  def update
    if @artist.update(artist_params)
      redirect_to admin_concerts_artist_path(@artist), notice: 'Artist was successfully updated.'
    else
