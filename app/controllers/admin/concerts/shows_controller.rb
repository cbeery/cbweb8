class Admin::Concerts::ShowsController < Admin::BaseController
  ...
  def create
    ...
    if @concert.save
      redirect_to admin_concerts_show_path(@concert), notice: 'Concert was successfully created.'
    else
  ...
  def update
    if @concert.update(concert_params_with_new_records)
      redirect_to admin_concerts_show_path(@concert), notice: 'Concert was successfully updated.'
    else
  ...
  def destroy
    @concert.destroy!
    redirect_to admin_concerts_shows_path, notice: 'Concert was successfully deleted.'
  end
